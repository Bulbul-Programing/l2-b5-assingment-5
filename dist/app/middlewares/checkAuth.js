...
const checkAuth = (...authRoles) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const verifiedToken = (0, jwtToken_1.verifyToken)(accessToken, env_1.envVars.JWT_ACCESS_SECRET);
        ...
        if (!authRoles.includes(verifiedToken.role)) {
            throw new AppError_1.AppError(403, "You are not authorized for this route!!!");
        }
